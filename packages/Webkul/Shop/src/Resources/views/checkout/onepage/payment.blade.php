                    ...
                    <x-slot:content class="mt-8 !p-0 max-md:mt-0 max-md:rounded-t-none max-md:border max-md:border-t-0 max-md:!p-4">
                        <div class="flex flex-wrap gap-7 max-md:gap-4 max-sm:gap-2.5">
                            ...
                            >
                                ...
                                <label
                                        :for="payment.method"
                                        class=" min-w-[190px] max-w-full cursor-pointer rounded-xl border border-zinc-200 p-5 flex flex-col gap-2 max-md:flex max-md:w-full max-md:gap-5 max-md:rounded-lg max-sm:gap-4 max-sm:px-4 max-sm:py-2.5"
                                    >
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <p
                                                class="mt-2.5 text-lg font-medium text-zinc-700 max-md:mt-1 max-sm:mt-0"
