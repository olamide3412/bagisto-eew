    ...
    >
        ...
        >
            <div class="relative">
                <div
                    ref="swiperContainer"
                    class="scrollbar-hide flex gap-10 overflow-auto scroll-smooth max-lg:gap-10"
                >
                    <div
                        ...
                        <a
                            :href="category.slug"
                            class="h-[110px] w-[110px] rounded-full shadow-lg bg-zinc-100  max-md:h-20 max-md:w-20 max-sm:h-[60px] max-sm:w-[60px]"
